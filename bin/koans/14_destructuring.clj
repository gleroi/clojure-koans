...
(meditations
  ...
  (= (str "First comes love, "
          "then comes marriage, "
          "then comes Clojure with baby carriage")
     ((fn [[a b c]] (str "First comes " a ", then comes " b ", then comes " c " with baby carriage"))
...
;          (clojure.string/join ", " (sort (vals test-address))))))
)